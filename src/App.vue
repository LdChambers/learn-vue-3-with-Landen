...
watch(() => wizard1.value.name, (newValue, oldValue) => {
  console.log(
    "Watch a property in ref(object): wizard1 name changes", newValue, oldValue
  )
})

watch(() => wizard1.value.wand, (newValue, oldValue) => {
  console.log(
    "Watch a property in ref(object): wizard1 wand changes", newValue, oldValue
  )
}, { deep: true })
...
watch(wizard2, (newValue, oldValue) => {
  console.log(
    "Watch a ref(object): wizard2 changes", newValue, oldValue
  )
}, { deep: true })
